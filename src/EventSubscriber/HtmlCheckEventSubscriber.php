<?php
    ...
    class HtmlCheckEventSubscriber implements EventSubscriberInterface {
      ...
      //Used by this->validate_html() & this->get_dom_obj() & this->test_pagespeed() & this->accessability_checker() & this->test_structured_data()!!!
      ...
      private function check_source($dom_obj, $domain, $html_source){
          ...
          $messages.= $this->test_structured_data($dom_obj);
      ...
      private function test_structured_data($dom_obj){
          ...
          if($snippets){
              ...
              if($messages){
                  return "<li style='color:red'>Structured data:<ul>".$messages."</ul></li>";
              }
          }
      }
